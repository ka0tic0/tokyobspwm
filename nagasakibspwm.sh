...
install_official_packages() {
    ...
    local OFFICIAL_PKGS=(
        ...
        pipewire pipewire-pulse wireplumber pulseaudio-utils pavucontrol alsa-utils
        # Fuentes tipográficas y soporte íconos
        ttf-jetbrains-mono-nerd ttf-font-awesome ttf-dejavu ttf-liberation
