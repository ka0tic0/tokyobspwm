...
# ------------------------------------------------------------------------------
setup_rices_engine() {
    log_info "5.1 Configurando Motor Multi-Rice Global con 8 diseños de Polybar únicos inspirados en gh0stzk..."
...
EOF
    ...
    log_success "Motor Multi-Rice global de 8 temas con barras Polybar 100% independientes configurado en $RICES_DIR."
}
